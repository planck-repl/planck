...
(deftest read-eval-print-exception-in-exit-context
  (js/PLANCK_SET_EXIT_VALUE 0)
  (let [result (planck.repl/execute "(throw (js/Error. \"bye-bye\"))" "cljs" nil false false true)]
...
(deftest read-eval-print-exception-outside-exit-context
  (js/PLANCK_SET_EXIT_VALUE 0)
  (let [result (planck.repl/execute "(throw (js/Error. \"bye-bye\"))" "cljs" nil false false false)]
