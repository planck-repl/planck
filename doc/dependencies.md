...
Planck ships with many of the deps that are available to conventional ClojureScript code. In particular this includes [the majority of the Google Closure Library](https://cljdoc.org/d/planck/planck/doc/gcl) as well as these namespaces:
